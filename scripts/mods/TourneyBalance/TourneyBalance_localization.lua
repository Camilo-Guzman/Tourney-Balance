...
local localization = {
	...
	tourney_display_mods_title = {
		en = "Display Mods",
		fr = "Afficher les mods",
		de = "Mods anzeigen",
		it = "Mostra mod",
		pl = "Wyświetl mody",
		zh = "显示模组",
	...
	tourney_display_mods_description = {
		en = "Displays all currently enabled unapproved mods.",
		fr = "Affiche tous les mods non approuvés actuellement activés.",
		de = "Zeigt alle derzeit aktivierten nicht genehmigten Mods an.",
		it = "Mostra tutte le mod non approvate attualmente attive.",
		pl = "Wyświetla wszystkie obecnie włączone niezatwierdzone mody.",
		zh = "显示所有当前启用的未批准模组。",
		ru = "Отображает все включенные в данный момент неутверждённые моды.",
		es = "Muestra todos los mods no aprobados que están actualmente activados.",
		["br-pt"] = "Exibe todos os mods não aprovados atualmente habilitados.",
		ko = "현재 활성화된 승인되지 않은 모드를 표시합니다.",
	},
	font_size_title = {
		en = "Font Size",
		fr = "Taille de police",
